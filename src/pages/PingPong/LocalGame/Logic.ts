...
class GameLogic {
    ...
    constructor(ballElem: any, rightPaddel: any, lefttPaddel: any, type: Enum = Enum.LEFT) {
        ...
        this._leftScore = 0;
        this._rightScore = 0;
        this.speed = GameLogic.initialSpeed;
    }
    ...
    get getRightPaddle(): Paddle { return this.rightPaddle; }

    get getLeftPaddle(): Paddle { return this.leftPaddle; }
    ...
    updateGame(deltaTime: number) {
        this.speed += GameLogic.acceleration;
