...
function Settings() {
	...
	return (
		...
		<motion.div
			...
			<div className="z-50 fixed bg-secondary max-h-[663px] min-h-[450px] max-w-[652px] w-[90%] h-[90%] rounded-[10px] left-[50%] -translate-x-1/2 top-1/2 -translate-y-1/2 flex flex-col justify-between px-11 pt-16 pb-9">
